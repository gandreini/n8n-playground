...
export function WorkflowRow({ workflow, onClick }: WorkflowRowProps) {
    ...
    return (
        <div
            onClick={onClick}
            className={cn(
                "n8n-workflow-row flex items-center justify-between bg-[var(--color--neutral-white)] border border-[var(--color--neutral-200)] rounded-[var(--radius--xs)] p-4 hover:border-[var(--color--neutral-300)] transition-snappy",
        ...
        >
            ...
            <div className="flex flex-col gap-0.5 min-w-0">
                ...
                <div className="flex items-center gap-1 flex-wrap">
                    <span className="text-[length:var(--font-size--2xs)] text-[color:var(--color--text--tint-1)] leading-[18px] whitespace-nowrap">
                        Last updated{" "}
                        {formatDistanceToNowStrict(workflow.lastUpdated)} ago
