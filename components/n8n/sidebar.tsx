...
function NavItem({ icon, label, active, badge, compact, hasNotification, onClick }: NavItemProps) {
  return (
    <button
      onClick={onClick}
      className={cn(
    ...
    >
      ...
      {!compact && (
        <>
          <span className="flex-1 text-[length:var(--font-size--xs)] truncate">{label}</span>
          {badge && (
    ...
    <aside className="n8n-sidebar relative h-full flex flex-col border-r border-[var(--border-color--light,var(--color--neutral-150))] bg-[var(--menu--color--background,var(--color--neutral-50))] w-[200px]">
      ...
      <div className="flex items-center px-[var(--spacing--3xs)] py-[var(--spacing--2xs)] gap-[var(--spacing--4xs)]">
        ...
        <button className="n8n-button--highlight p-1.5 rounded-[var(--radius--3xs)] hover:bg-[var(--color--neutral-125)] transition-snappy">
          <Plus className="w-5 h-5 text-[var(--color--neutral-500)]" />
        </button>
        <button className="n8n-button--highlight p-1.5 rounded-[var(--radius--3xs)] hover:bg-[var(--color--neutral-125)] transition-snappy">
          <Search className="w-5 h-5 text-[var(--color--neutral-500)]" />
        </button>
        <button className="n8n-button--highlight p-1.5 rounded-[var(--radius--3xs)] hover:bg-[var(--color--neutral-125)] transition-snappy">
          <PanelLeft className="w-5 h-5 text-[var(--color--neutral-500)]" />
        </button>
      </div>
